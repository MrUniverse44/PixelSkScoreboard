...
public class CondLinesExistsWithoutName extends Condition {
    Expression<String> file;


    static {
        Skript.registerCondition(CondLinesExistsWithoutName.class, "(scoreboard|skscoreboard) lines (in|of) file %string% (1¦is|2¦is(n't| not)) created");
    }
    ...
    public @NotNull String toString(@Nullable Event event, boolean debug) {
        return "scoreboard lines in file " + file.toString(event,debug) + " isn't created";
    }
    ...
    public boolean check(@NotNull Event event) {
        ...
        try {
            ...
            return configuration.contains("scoreboard.lines") ? isNegated() : (!isNegated());
