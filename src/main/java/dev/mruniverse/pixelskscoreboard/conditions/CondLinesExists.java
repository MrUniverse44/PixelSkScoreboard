...
public class CondLinesExists extends Condition {
    Expression<String> name;
    Expression<String> file;


    static {
        Skript.registerCondition(CondLinesExists.class, "(scoreboard|skscoreboard) lines[ of board] named %string% (in|of) file %string% (1¦is|2¦is(n't| not)) created");
    }
    ...
    public @NotNull String toString(@Nullable Event event, boolean debug) {
        return "scoreboard lines of board named " + name.toString(event,debug) + " in file " + file.toString(event,debug) + " isn't created";
    }
    ...
    public boolean check(@NotNull Event event) {
        ...
        try {
            ...
            return configuration.contains("scoreboards." + name.getSingle(event) + ".lines") ? isNegated() : (!isNegated());
